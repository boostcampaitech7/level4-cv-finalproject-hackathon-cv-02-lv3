...
data_path = '/data/ephemeral/home/Dongjin/level4-cv-finalproject-hackathon-cv-02-lv3/autoML/0127/melb_split.csv'
...
automl = autosklearn.regression.AutoSklearnRegressor(
    time_left_for_this_task=300, # 전체 작업 시간 제한 (초 단위)
    per_run_time_limit=50, # 각 모델의 시간 제한 (초 단위)
    tmp_folder="/data/ephemeral/home/temp", # 임시 폴더 경로 
)

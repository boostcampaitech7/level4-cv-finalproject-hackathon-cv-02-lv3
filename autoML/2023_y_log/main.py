...
def main(n_population=30, n_generation=5, n_parent=5, prob_mutations=[0.2, 0.5], use_joblib=True, n_jobs=-1, use_kfold=True, kfold=5, timeout=30, seed=42, y_scale_log=False):
    ...
    autoML = AutoML(n_population=n_population, n_generation=n_generation,
                    ...
                    use_joblib=use_joblib, n_jobs=n_jobs, y_scale_log=y_scale_log)
...
if __name__ == '__main__':
    main(use_joblib=True, timeout=30, y_scale_log=True)

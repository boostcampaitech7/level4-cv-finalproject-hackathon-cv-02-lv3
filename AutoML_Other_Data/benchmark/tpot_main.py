...
pipeline_optimizer = TPOTClassifier(generations=5, population_size=30, cv=5, random_state=42, verbosity=2, scoring="f1", n_jobs=-1)
pipeline_optimizer.fit(X_train, y_train)
print(pipeline_optimizer.score(X_test, y_test)) # 0.7821675437298992
# 0.17391304347826086 - f1
